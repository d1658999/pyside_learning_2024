...
################################################################################
## Form generated from reading UI file 'mega_v2_11.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QWidget(self.mcs_lte_group)
        ...
        self.groupBox_3 = QGroupBox(self.layoutWidget9)
        ...
        self.layoutWidget11 = QWidget(self.groupBox_3)
        self.layoutWidget11.setObjectName(u"layoutWidget11")
        self.layoutWidget11.setGeometry(QRect(10, 200, 91, 48))
        self.verticalLayout_criteria_ulca_lte = QVBoxLayout(self.layoutWidget11)
        ...
        self.criteria_ulca_lte_3gpp_radioButton = QRadioButton(self.layoutWidget11)
        ...
        self.criteria_ulca_lte_fcc_radioButton = QRadioButton(self.layoutWidget11)
        ...
        self.layoutWidget12 = QWidget(self.temp_psu_tab)
        self.layoutWidget12.setObjectName(u"layoutWidget12")
        self.layoutWidget12.setGeometry(QRect(10, 10, 761, 701))
        self.horizontalLayout_5 = QHBoxLayout(self.layoutWidget12)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.temp_chamber_psu_groupBox = QGroupBox(self.layoutWidget12)
        ...
        self.layoutWidget13 = QWidget(self.temp_chamber_psu_groupBox)
        self.layoutWidget13.setObjectName(u"layoutWidget13")
        self.layoutWidget13.setGeometry(QRect(10, 30, 131, 152))
        self.verticalLayout_tmpchb_psu = QVBoxLayout(self.layoutWidget13)
        ...
        self.layoutWidget14.setGeometry(QRect(10, 210, 131, 46))
        self.verticalLayout_5 = QVBoxLayout(self.layoutWidget14)
        self.verticalLayout_5.setObjectName(u"verticalLayout_5")
        self.verticalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.wait_time_label = QLabel(self.layoutWidget14)
        self.wait_time_label.setObjectName(u"wait_time_label")

        self.verticalLayout_5.addWidget(self.wait_time_label)

        self.wait_time_comboBox = QComboBox(self.layoutWidget14)
        ...
        self.psu_groupBox = QGroupBox(self.layoutWidget12)
        self.psu_groupBox.setObjectName(u"psu_groupBox")
        self.layoutWidget15 = QWidget(self.psu_groupBox)
        self.layoutWidget15.setObjectName(u"layoutWidget15")
        self.layoutWidget15.setGeometry(QRect(7, 30, 131, 100))
        self.verticalLayout_6 = QVBoxLayout(self.layoutWidget15)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.psu_en = QCheckBox(self.layoutWidget15)
        self.psu_en.setObjectName(u"psu_en")

        self.verticalLayout_6.addWidget(self.psu_en)

        self.hv_en = QCheckBox(self.layoutWidget15)
        self.hv_en.setObjectName(u"hv_en")

        self.verticalLayout_6.addWidget(self.hv_en)

        self.nv_en = QCheckBox(self.layoutWidget15)
        self.nv_en.setObjectName(u"nv_en")

        self.verticalLayout_6.addWidget(self.nv_en)

        self.lv_en = QCheckBox(self.layoutWidget15)
        ...
        self.odpm_groupBox = QGroupBox(self.layoutWidget12)
        ...
        self.count_groupBox = QGroupBox(self.layoutWidget12)
        ...
        self.temp_arg_groupBox = QGroupBox(self.layoutWidget12)
        self.temp_arg_groupBox.setObjectName(u"temp_arg_groupBox")
        self.layoutWidget16 = QWidget(self.temp_arg_groupBox)
        self.layoutWidget16.setObjectName(u"layoutWidget16")
        self.layoutWidget16.setGeometry(QRect(10, 30, 131, 296))
        self.verticalLayout_temp_arg = QVBoxLayout(self.layoutWidget16)
        ...
        self.ht_label = QLabel(self.layoutWidget16)
        ...
        self.ht_spinBox = QSpinBox(self.layoutWidget16)
        ...
        self.nt_label = QLabel(self.layoutWidget16)
        ...
        self.nt_spinBox = QSpinBox(self.layoutWidget16)
        ...
        self.lt_label = QLabel(self.layoutWidget16)
        ...
        self.lt_spinBox = QSpinBox(self.layoutWidget16)
        ...
        self.hv_label = QLabel(self.layoutWidget16)
        ...
        self.hv_doubleSpinBox = QDoubleSpinBox(self.layoutWidget16)
        ...
        self.nv_label = QLabel(self.layoutWidget16)
        ...
        self.nv_doubleSpinBox = QDoubleSpinBox(self.layoutWidget16)
        ...
        self.lv_label = QLabel(self.layoutWidget16)
        ...
        self.lv_doubleSpinBox = QDoubleSpinBox(self.layoutWidget16)
        ...
        self.layoutWidget17 = QWidget(self.groupBox)
        self.layoutWidget17.setObjectName(u"layoutWidget17")
        self.layoutWidget17.setGeometry(QRect(10, 30, 131, 96))
        self.verticalLayout_14 = QVBoxLayout(self.layoutWidget17)
        self.verticalLayout_14.setObjectName(u"verticalLayout_14")
        self.verticalLayout_14.setContentsMargins(0, 0, 0, 0)
        self.inpur_level_sig_label = QLabel(self.layoutWidget17)
        ...
        self.input_level_sig_anritsu_spinBox = QSpinBox(self.layoutWidget17)
        ...
        self.layoutWidget18 = QWidget(self.centralwidget)
        self.layoutWidget18.setObjectName(u"layoutWidget18")
        self.layoutWidget18.setGeometry(QRect(594, 0, 111, 741))
        self.verticalLayout_tech_ch = QVBoxLayout(self.layoutWidget18)
        self.verticalLayout_tech_ch.setObjectName(u"verticalLayout_tech_ch")
        self.verticalLayout_tech_ch.setContentsMargins(0, 0, 0, 0)
        self.tech_group = QGroupBox(self.layoutWidget18)
        ...
        self.layoutWidget20 = QWidget(self.general_sync)
        self.layoutWidget20.setObjectName(u"layoutWidget20")
        self.layoutWidget20.setGeometry(QRect(0, -1, 121, 332))
        self.verticalLayout_genre = QVBoxLayout(self.layoutWidget20)
        self.verticalLayout_genre.setObjectName(u"verticalLayout_genre")
        self.verticalLayout_genre.setContentsMargins(0, 0, 0, 0)
        self.sync_path_label = QLabel(self.layoutWidget20)
        ...
        self.sync_path_comboBox = QComboBox(self.layoutWidget20)
        ...
        self.as_path_en = QCheckBox(self.layoutWidget20)
        self.as_path_en.setObjectName(u"as_path_en")

        self.verticalLayout_genre.addWidget(self.as_path_en)

        self.as_path_comboBox = QComboBox(self.layoutWidget20)
        ...
        self.srs_path_en = QCheckBox(self.layoutWidget20)
        ...
        self.srs_path_comboBox = QComboBox(self.layoutWidget20)
        ...
        self.tx_level_nlw_label = QLabel(self.layoutWidget20)
        ...
        self.tx_level_spinBox = QSpinBox(self.layoutWidget20)
        ...
        self.pcl_lb_label = QLabel(self.layoutWidget20)
        ...
        self.pcl_lb_level_combo = QComboBox(self.layoutWidget20)
        ...
        self.pcl_mb_label = QLabel(self.layoutWidget20)
        ...
        self.pcl_mb_level_combo = QComboBox(self.layoutWidget20)
        ...
        self.gmsk_radioButton = QRadioButton(self.layoutWidget20)
        ...
        self.epsk_radioButton = QRadioButton(self.layoutWidget20)
