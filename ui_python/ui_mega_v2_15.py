...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page_nr.setGeometry(QRect(0, 0, 771, 521))
        self.layoutWidget = QWidget(self.page_nr)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(0, 0, 771, 521))
        ...
        self.layoutWidget_30.setGeometry(QRect(10, 20, 231, 491))
        ...
        self.layoutWidget_29.setGeometry(QRect(10, 20, 231, 491))
        ...
        self.n1_docomo_nr = QCheckBox(self.layoutWidget_29)
        self.n1_docomo_nr.setObjectName(u"n1_docomo_nr")

        self.gridLayout_mb_nr.addWidget(self.n1_docomo_nr, 9, 0, 1, 1)

        self.n1_kddi_nr = QCheckBox(self.layoutWidget_29)
        self.n1_kddi_nr.setObjectName(u"n1_kddi_nr")

        self.gridLayout_mb_nr.addWidget(self.n1_kddi_nr, 9, 1, 1, 1)
        ...
        self.layoutWidget_2.setGeometry(QRect(10, 20, 231, 231))
        ...
        self.page_lte.setGeometry(QRect(0, 0, 771, 521))
        self.layoutWidget1 = QWidget(self.page_lte)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(0, 0, 771, 521))
        ...
        self.layoutWidget_31.setGeometry(QRect(10, 20, 231, 491))
        ...
        self.b8_jrf_lte = QCheckBox(self.layoutWidget_31)
        self.b8_jrf_lte.setObjectName(u"b8_jrf_lte")

        self.gridLayout_lb_lte.addWidget(self.b8_jrf_lte, 7, 1, 1, 1)
        ...
        self.layoutWidget_4.setGeometry(QRect(10, 20, 231, 491))
        ...
        self.b1_docomo_lte = QCheckBox(self.layoutWidget_4)
        self.b1_docomo_lte.setObjectName(u"b1_docomo_lte")

        self.gridLayout_mb_lte.addWidget(self.b1_docomo_lte, 5, 1, 1, 1)
        ...
        self.layoutWidget_5.setGeometry(QRect(10, 20, 231, 121))
        ...
        self.page_wcdma.setGeometry(QRect(0, 0, 771, 521))
        self.layoutWidget2 = QWidget(self.page_wcdma)
        self.layoutWidget2.setObjectName(u"layoutWidget2")
        self.layoutWidget2.setGeometry(QRect(0, 0, 771, 521))
        ...
        self.page_gsm.setGeometry(QRect(0, 0, 771, 521))
        self.layoutWidget3 = QWidget(self.page_gsm)
        self.layoutWidget3.setObjectName(u"layoutWidget3")
        self.layoutWidget3.setGeometry(QRect(0, 0, 771, 521))
        ...
        self.page_endc_desense = QWidget()
        self.page_endc_desense.setObjectName(u"page_endc_desense")
        self.page_endc_desense.setGeometry(QRect(0, 0, 771, 521))
        self.layoutWidget_32 = QWidget(self.page_endc_desense)
        self.layoutWidget_32.setObjectName(u"layoutWidget_32")
        self.layoutWidget_32.setGeometry(QRect(0, 0, 771, 521))
        self.horizontalLayout_bnads_gsm_2 = QHBoxLayout(self.layoutWidget_32)
        self.horizontalLayout_bnads_gsm_2.setObjectName(u"horizontalLayout_bnads_gsm_2")
        self.horizontalLayout_bnads_gsm_2.setContentsMargins(0, 0, 0, 0)
        self.groupBox_endc_desense = QGroupBox(self.layoutWidget_32)
        self.groupBox_endc_desense.setObjectName(u"groupBox_endc_desense")
        self.layoutWidget4 = QWidget(self.groupBox_endc_desense)
        self.layoutWidget4.setObjectName(u"layoutWidget4")
        self.layoutWidget4.setGeometry(QRect(10, 30, 281, 171))
        self.gridLayout_2 = QGridLayout(self.layoutWidget4)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.b28_n78 = QCheckBox(self.layoutWidget4)
        self.b28_n78.setObjectName(u"b28_n78")

        self.gridLayout_2.addWidget(self.b28_n78, 2, 1, 1, 1)

        self.b5_n77 = QCheckBox(self.layoutWidget4)
        self.b5_n77.setObjectName(u"b5_n77")

        self.gridLayout_2.addWidget(self.b5_n77, 3, 1, 1, 1)

        self.b66_n2 = QCheckBox(self.layoutWidget4)
        self.b66_n2.setObjectName(u"b66_n2")

        self.gridLayout_2.addWidget(self.b66_n2, 3, 0, 1, 1)

        self.b5_n78 = QCheckBox(self.layoutWidget4)
        self.b5_n78.setObjectName(u"b5_n78")

        self.gridLayout_2.addWidget(self.b5_n78, 1, 1, 1, 1)

        self.b13_n5 = QCheckBox(self.layoutWidget4)
        self.b13_n5.setObjectName(u"b13_n5")

        self.gridLayout_2.addWidget(self.b13_n5, 4, 1, 1, 1)

        self.b2_n77 = QCheckBox(self.layoutWidget4)
        self.b2_n77.setObjectName(u"b2_n77")

        self.gridLayout_2.addWidget(self.b2_n77, 1, 0, 1, 1)

        self.b66_n5 = QCheckBox(self.layoutWidget4)
        self.b66_n5.setObjectName(u"b66_n5")

        self.gridLayout_2.addWidget(self.b66_n5, 4, 0, 1, 1)

        self.b66_n77 = QCheckBox(self.layoutWidget4)
        self.b66_n77.setObjectName(u"b66_n77")

        self.gridLayout_2.addWidget(self.b66_n77, 2, 0, 1, 1)

        self.b12_n78 = QCheckBox(self.layoutWidget4)
        self.b12_n78.setObjectName(u"b12_n78")

        self.gridLayout_2.addWidget(self.b12_n78, 0, 1, 1, 1)

        self.b3_n78 = QCheckBox(self.layoutWidget4)
        self.b3_n78.setObjectName(u"b3_n78")

        self.gridLayout_2.addWidget(self.b3_n78, 0, 0, 1, 1)

        self.b7_n77 = QCheckBox(self.layoutWidget4)
        self.b7_n77.setObjectName(u"b7_n77")

        self.gridLayout_2.addWidget(self.b7_n77, 5, 0, 1, 1)


        self.horizontalLayout_bnads_gsm_2.addWidget(self.groupBox_endc_desense)

        self.bands_toolBox.addItem(self.page_endc_desense, u"ENDC_desense")
        self.tabWidget.addTab(self.bands, "")
        self.bw = QWidget()
        self.bw.setObjectName(u"bw")
        self.layoutWidget5 = QWidget(self.bw)
        self.layoutWidget5.setObjectName(u"layoutWidget5")
        self.layoutWidget5.setGeometry(QRect(10, 10, 761, 511))
        self.horizontalLayout_bw = QHBoxLayout(self.layoutWidget5)
        self.horizontalLayout_bw.setObjectName(u"horizontalLayout_bw")
        self.horizontalLayout_bw.setContentsMargins(0, 0, 0, 0)
        self.lte_bw_groupBox = QGroupBox(self.layoutWidget5)
        ...
        self.nr_bw_groupBox = QGroupBox(self.layoutWidget5)
        ...
        self.layoutWidget7 = QWidget(self.mcs_rb)
        self.layoutWidget7.setObjectName(u"layoutWidget7")
        self.layoutWidget7.setGeometry(QRect(10, 11, 761, 691))
        self.gridLayout = QGridLayout(self.layoutWidget7)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.mcs_nr_group = QGroupBox(self.layoutWidget7)
        ...
        self.rb_nr_group = QGroupBox(self.layoutWidget7)
        ...
        self.mcs_lte_group = QGroupBox(self.layoutWidget7)
        self.mcs_lte_group.setObjectName(u"mcs_lte_group")
        self.layoutWidget9 = QWidget(self.mcs_lte_group)
        self.layoutWidget9.setObjectName(u"layoutWidget9")
        self.layoutWidget9.setGeometry(QRect(10, 20, 361, 311))
        self.horizontalLayout_2 = QHBoxLayout(self.layoutWidget9)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.groupBox_4 = QGroupBox(self.layoutWidget9)
        self.groupBox_4.setObjectName(u"groupBox_4")
        self.layoutWidget_21 = QWidget(self.groupBox_4)
        self.layoutWidget_21.setObjectName(u"layoutWidget_21")
        self.layoutWidget_21.setGeometry(QRect(10, 30, 161, 101))
        ...
        self.groupBox_5 = QGroupBox(self.layoutWidget9)
        self.groupBox_5.setObjectName(u"groupBox_5")
        self.layoutWidget_27 = QWidget(self.groupBox_5)
        self.layoutWidget_27.setObjectName(u"layoutWidget_27")
        self.layoutWidget_27.setGeometry(QRect(10, 30, 161, 204))
        self.verticalLayout_mcs_lte_2 = QVBoxLayout(self.layoutWidget_27)
        self.verticalLayout_mcs_lte_2.setObjectName(u"verticalLayout_mcs_lte_2")
        self.verticalLayout_mcs_lte_2.setContentsMargins(0, 0, 0, 0)
        self.qpsk_1rb0_lte_sig = QCheckBox(self.layoutWidget_27)
        self.qpsk_1rb0_lte_sig.setObjectName(u"qpsk_1rb0_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.qpsk_1rb0_lte_sig)

        self.qpsk_prb0_lte_sig = QCheckBox(self.layoutWidget_27)
        self.qpsk_prb0_lte_sig.setObjectName(u"qpsk_prb0_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.qpsk_prb0_lte_sig)

        self.qpsk_frb_lte_sig = QCheckBox(self.layoutWidget_27)
        self.qpsk_frb_lte_sig.setObjectName(u"qpsk_frb_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.qpsk_frb_lte_sig)

        self.q16_prb0_lte_sig = QCheckBox(self.layoutWidget_27)
        self.q16_prb0_lte_sig.setObjectName(u"q16_prb0_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.q16_prb0_lte_sig)

        self.q16_frb_lte_sig = QCheckBox(self.layoutWidget_27)
        self.q16_frb_lte_sig.setObjectName(u"q16_frb_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.q16_frb_lte_sig)

        self.q64_prb0_lte_sig = QCheckBox(self.layoutWidget_27)
        self.q64_prb0_lte_sig.setObjectName(u"q64_prb0_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.q64_prb0_lte_sig)

        self.q64_frb_lte_sig = QCheckBox(self.layoutWidget_27)
        self.q64_frb_lte_sig.setObjectName(u"q64_frb_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.q64_frb_lte_sig)

        self.q256_frb_lte_sig = QCheckBox(self.layoutWidget_27)
        self.q256_frb_lte_sig.setObjectName(u"q256_frb_lte_sig")

        self.verticalLayout_mcs_lte_2.addWidget(self.q256_frb_lte_sig)
        ...
        self.groupBox_3 = QGroupBox(self.layoutWidget10)
        ...
        self.layoutWidget12 = QWidget(self.groupBox_3)
        self.layoutWidget12.setObjectName(u"layoutWidget12")
        self.layoutWidget12.setGeometry(QRect(10, 200, 91, 48))
        self.verticalLayout_criteria_ulca_lte = QVBoxLayout(self.layoutWidget12)
        ...
        self.criteria_ulca_lte_3gpp_radioButton = QRadioButton(self.layoutWidget12)
        ...
        self.criteria_ulca_lte_fcc_radioButton = QRadioButton(self.layoutWidget12)
        ...
        self.layoutWidget13 = QWidget(self.temp_psu_tab)
        self.layoutWidget13.setObjectName(u"layoutWidget13")
        self.layoutWidget13.setGeometry(QRect(10, 10, 761, 701))
        self.horizontalLayout_5 = QHBoxLayout(self.layoutWidget13)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.temp_chamber_psu_groupBox = QGroupBox(self.layoutWidget13)
        ...
        self.layoutWidget14 = QWidget(self.temp_chamber_psu_groupBox)
        self.layoutWidget14.setObjectName(u"layoutWidget14")
        self.layoutWidget14.setGeometry(QRect(10, 30, 131, 152))
        self.verticalLayout_tmpchb_psu = QVBoxLayout(self.layoutWidget14)
        ...
        self.odpm_groupBox = QGroupBox(self.layoutWidget13)
        ...
        self.count_groupBox = QGroupBox(self.layoutWidget13)
        ...
        self.temp_arg_groupBox = QGroupBox(self.layoutWidget13)
        self.temp_arg_groupBox.setObjectName(u"temp_arg_groupBox")
        self.layoutWidget17 = QWidget(self.temp_arg_groupBox)
        self.layoutWidget17.setObjectName(u"layoutWidget17")
        self.layoutWidget17.setGeometry(QRect(10, 30, 131, 296))
        self.verticalLayout_temp_arg = QVBoxLayout(self.layoutWidget17)
        ...
        self.ht_label = QLabel(self.layoutWidget17)
        ...
        self.ht_spinBox = QSpinBox(self.layoutWidget17)
        ...
        self.nt_label = QLabel(self.layoutWidget17)
        ...
        self.nt_spinBox = QSpinBox(self.layoutWidget17)
        ...
        self.lt_label = QLabel(self.layoutWidget17)
        ...
        self.lt_spinBox = QSpinBox(self.layoutWidget17)
        ...
        self.hv_label = QLabel(self.layoutWidget17)
        ...
        self.hv_doubleSpinBox = QDoubleSpinBox(self.layoutWidget17)
        ...
        self.nv_label = QLabel(self.layoutWidget17)
        ...
        self.nv_doubleSpinBox = QDoubleSpinBox(self.layoutWidget17)
        ...
        self.lv_label = QLabel(self.layoutWidget17)
        ...
        self.lv_doubleSpinBox = QDoubleSpinBox(self.layoutWidget17)
        ...
        self.nonsig_extra_setting = QWidget()
        self.nonsig_extra_setting.setObjectName(u"nonsig_extra_setting")
        self.layoutWidget_26 = QWidget(self.nonsig_extra_setting)
        self.layoutWidget_26.setObjectName(u"layoutWidget_26")
        self.layoutWidget_26.setGeometry(QRect(10, 20, 131, 146))
        self.verticalLayout_15 = QVBoxLayout(self.layoutWidget_26)
        self.verticalLayout_15.setObjectName(u"verticalLayout_15")
        self.verticalLayout_15.setContentsMargins(0, 0, 0, 0)
        self.init_rx_sync_level_label_2 = QLabel(self.layoutWidget_26)
        self.init_rx_sync_level_label_2.setObjectName(u"init_rx_sync_level_label_2")

        self.verticalLayout_15.addWidget(self.init_rx_sync_level_label_2)

        self.outer_loop_spinBox = QSpinBox(self.layoutWidget_26)
        self.outer_loop_spinBox.setObjectName(u"outer_loop_spinBox")
        self.outer_loop_spinBox.setAlignment(Qt.AlignCenter)
        self.outer_loop_spinBox.setMinimum(1)
        self.outer_loop_spinBox.setMaximum(10000)
        self.outer_loop_spinBox.setSingleStep(1)
        self.outer_loop_spinBox.setValue(1)

        self.verticalLayout_15.addWidget(self.outer_loop_spinBox)

        self.init_rx_sync_level_label = QLabel(self.layoutWidget_26)
        self.init_rx_sync_level_label.setObjectName(u"init_rx_sync_level_label")

        self.verticalLayout_15.addWidget(self.init_rx_sync_level_label)

        self.init_rx_sync_level_spinBox = QSpinBox(self.layoutWidget_26)
        self.init_rx_sync_level_spinBox.setObjectName(u"init_rx_sync_level_spinBox")
        self.init_rx_sync_level_spinBox.setAlignment(Qt.AlignCenter)
        self.init_rx_sync_level_spinBox.setMinimum(-130)
        self.init_rx_sync_level_spinBox.setMaximum(-10)
        self.init_rx_sync_level_spinBox.setSingleStep(1)
        self.init_rx_sync_level_spinBox.setValue(-70)

        self.verticalLayout_15.addWidget(self.init_rx_sync_level_spinBox)

        self.et_tracker_label = QLabel(self.layoutWidget_26)
        self.et_tracker_label.setObjectName(u"et_tracker_label")

        self.verticalLayout_15.addWidget(self.et_tracker_label)

        self.et_tracker_comboBox = QComboBox(self.layoutWidget_26)
        self.et_tracker_comboBox.addItem("")
        self.et_tracker_comboBox.addItem("")
        self.et_tracker_comboBox.setObjectName(u"et_tracker_comboBox")

        self.verticalLayout_15.addWidget(self.et_tracker_comboBox)

        self.tabWidget.addTab(self.nonsig_extra_setting, "")
        ...
        self.layoutWidget18 = QWidget(self.groupBox)
        self.layoutWidget18.setObjectName(u"layoutWidget18")
        self.layoutWidget18.setGeometry(QRect(10, 30, 131, 96))
        self.verticalLayout_14 = QVBoxLayout(self.layoutWidget18)
        self.verticalLayout_14.setObjectName(u"verticalLayout_14")
        self.verticalLayout_14.setContentsMargins(0, 0, 0, 0)
        self.inpur_level_sig_label = QLabel(self.layoutWidget18)
        ...
        self.input_level_sig_anritsu_spinBox = QSpinBox(self.layoutWidget18)
        ...
        self.groupBox_6 = QGroupBox(self.regy_oper)
        self.groupBox_6.setObjectName(u"groupBox_6")
        self.groupBox_6.setGeometry(QRect(10, 10, 183, 164))
        ...
        self.baseRegyUpdatelineEdit = QLineEdit(self.groupBox_6)
        self.baseRegyUpdatelineEdit.setObjectName(u"baseRegyUpdatelineEdit")

        self.horizontalLayout_3.addWidget(self.baseRegyUpdatelineEdit)

        self.baseRegyFileUpdateButton = QToolButton(self.groupBox_6)
        self.baseRegyFileUpdateButton.setObjectName(u"baseRegyFileUpdateButton")

        self.horizontalLayout_3.addWidget(self.baseRegyFileUpdateButton)
        ...
        self.changedRegyUpdatelineEdit = QLineEdit(self.groupBox_6)
        self.changedRegyUpdatelineEdit.setObjectName(u"changedRegyUpdatelineEdit")

        self.horizontalLayout_4.addWidget(self.changedRegyUpdatelineEdit)

        self.changedRegyFileUpdateButton = QToolButton(self.groupBox_6)
        self.changedRegyFileUpdateButton.setObjectName(u"changedRegyFileUpdateButton")

        self.horizontalLayout_4.addWidget(self.changedRegyFileUpdateButton)


        self.verticalLayout_16.addLayout(self.horizontalLayout_4)

        self.mergeButton = QPushButton(self.groupBox_6)
        self.mergeButton.setObjectName(u"mergeButton")

        self.verticalLayout_16.addWidget(self.mergeButton)

        self.groupBox_7 = QGroupBox(self.regy_oper)
        self.groupBox_7.setObjectName(u"groupBox_7")
        self.groupBox_7.setGeometry(QRect(200, 10, 183, 164))
        ...
        self.baseRegySeparatelineEdit = QLineEdit(self.groupBox_7)
        self.baseRegySeparatelineEdit.setObjectName(u"baseRegySeparatelineEdit")

        self.horizontalLayout_6.addWidget(self.baseRegySeparatelineEdit)

        self.baseRegyFileSeparateButton = QToolButton(self.groupBox_7)
        self.baseRegyFileSeparateButton.setObjectName(u"baseRegyFileSeparateButton")

        self.horizontalLayout_6.addWidget(self.baseRegyFileSeparateButton)
        ...
        self.txtSeparatelineEdit = QLineEdit(self.groupBox_7)
        self.txtSeparatelineEdit.setObjectName(u"txtSeparatelineEdit")

        self.horizontalLayout_7.addWidget(self.txtSeparatelineEdit)

        self.txtFileSeparateButton = QToolButton(self.groupBox_7)
        self.txtFileSeparateButton.setObjectName(u"txtFileSeparateButton")

        self.horizontalLayout_7.addWidget(self.txtFileSeparateButton)


        self.verticalLayout_17.addLayout(self.horizontalLayout_7)

        self.seperateButton = QPushButton(self.groupBox_7)
        self.seperateButton.setObjectName(u"seperateButton")

        self.verticalLayout_17.addWidget(self.seperateButton)

        self.groupBox_8 = QGroupBox(self.regy_oper)
        self.groupBox_8.setObjectName(u"groupBox_8")
        self.groupBox_8.setGeometry(QRect(390, 10, 183, 164))
        ...
        self.baseRegyParselineEdit = QLineEdit(self.groupBox_8)
        self.baseRegyParselineEdit.setObjectName(u"baseRegyParselineEdit")

        self.horizontalLayout_8.addWidget(self.baseRegyParselineEdit)

        self.baseRegyFileParseButton = QToolButton(self.groupBox_8)
        self.baseRegyFileParseButton.setObjectName(u"baseRegyFileParseButton")

        self.horizontalLayout_8.addWidget(self.baseRegyFileParseButton)
        ...
        self.cfgFileParselineEdit = QLineEdit(self.groupBox_8)
        self.cfgFileParselineEdit.setObjectName(u"cfgFileParselineEdit")

        self.horizontalLayout_9.addWidget(self.cfgFileParselineEdit)

        self.cfgFileParseButton = QToolButton(self.groupBox_8)
        self.cfgFileParseButton.setObjectName(u"cfgFileParseButton")

        self.horizontalLayout_9.addWidget(self.cfgFileParseButton)


        self.verticalLayout_19.addLayout(self.horizontalLayout_9)

        self.parseButton = QPushButton(self.groupBox_8)
        self.parseButton.setObjectName(u"parseButton")

        self.verticalLayout_19.addWidget(self.parseButton)

        self.tabWidget.addTab(self.regy_oper, "")
        ...
        self.encc_path.setGeometry(QRect(0, 0, 131, 461))
        ...
        self.layoutWidget19 = QWidget(self.centralwidget)
        self.layoutWidget19.setObjectName(u"layoutWidget19")
        self.layoutWidget19.setGeometry(QRect(594, 0, 111, 741))
        self.verticalLayout_tech_ch = QVBoxLayout(self.layoutWidget19)
        self.verticalLayout_tech_ch.setObjectName(u"verticalLayout_tech_ch")
        self.verticalLayout_tech_ch.setContentsMargins(0, 0, 0, 0)
        self.tech_group = QGroupBox(self.layoutWidget19)
        ...
        self.rx_level_sweep_ns = QCheckBox(self.layoutWidget_11)
        self.rx_level_sweep_ns.setObjectName(u"rx_level_sweep_ns")

        self.verticalLayout_ns.addWidget(self.rx_level_sweep_ns)
        ...
        self.level_sweep_start_spinBox.setMinimum(-100)
        ...
        self.level_stop_spinBox.setMinimum(-100)
        ...
        self.layoutWidget21 = QWidget(self.general_sync)
        self.layoutWidget21.setObjectName(u"layoutWidget21")
        self.layoutWidget21.setGeometry(QRect(0, -1, 121, 332))
        self.verticalLayout_genre = QVBoxLayout(self.layoutWidget21)
        self.verticalLayout_genre.setObjectName(u"verticalLayout_genre")
        self.verticalLayout_genre.setContentsMargins(0, 0, 0, 0)
        self.sync_path_label = QLabel(self.layoutWidget21)
        ...
        self.sync_path_comboBox = QComboBox(self.layoutWidget21)
        ...
        self.as_path_en = QCheckBox(self.layoutWidget21)
        self.as_path_en.setObjectName(u"as_path_en")

        self.verticalLayout_genre.addWidget(self.as_path_en)

        self.as_path_comboBox = QComboBox(self.layoutWidget21)
        ...
        self.srs_path_en = QCheckBox(self.layoutWidget21)
        ...
        self.srs_path_comboBox = QComboBox(self.layoutWidget21)
        ...
        self.tx_level_nlw_label = QLabel(self.layoutWidget21)
        ...
        self.tx_level_spinBox = QSpinBox(self.layoutWidget21)
        ...
        self.pcl_lb_label = QLabel(self.layoutWidget21)
        ...
        self.pcl_lb_level_combo = QComboBox(self.layoutWidget21)
        ...
        self.pcl_mb_label = QLabel(self.layoutWidget21)
        ...
        self.pcl_mb_level_combo = QComboBox(self.layoutWidget21)
        ...
        self.gmsk_radioButton = QRadioButton(self.layoutWidget21)
        ...
        self.epsk_radioButton = QRadioButton(self.layoutWidget21)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.n1_docomo_nr.setText(QCoreApplication.translate("MainWindow", u"N1_DOCOMO", None))
        self.n1_kddi_nr.setText(QCoreApplication.translate("MainWindow", u"N1_KDDI", None))
        ...
        self.b8_jrf_lte.setText(QCoreApplication.translate("MainWindow", u"B8_JRF", None))
        ...
        self.groupBox_endc_desense.setTitle(QCoreApplication.translate("MainWindow", u"LB", None))
        ...
        self.b13_n5.setText(QCoreApplication.translate("MainWindow", u"B13_N5", None))
        self.b2_n77.setText(QCoreApplication.translate("MainWindow", u"B2_N77", None))
        self.b66_n5.setText(QCoreApplication.translate("MainWindow", u"B66_N5", None))
        ...
        self.b3_n78.setText(QCoreApplication.translate("MainWindow", u"B3_N78", None))
        self.b7_n77.setText(QCoreApplication.translate("MainWindow", u"B7_N77", None))
        self.bands_toolBox.setItemText(self.bands_toolBox.indexOf(self.page_endc_desense), QCoreApplication.translate("MainWindow", u"ENDC_desense", None))
        ...
        self.groupBox_4.setTitle(QCoreApplication.translate("MainWindow", u"Nonsignaling", None))
        ...
        self.groupBox_5.setTitle(QCoreApplication.translate("MainWindow", u"Signaling", None))
        self.qpsk_1rb0_lte_sig.setText(QCoreApplication.translate("MainWindow", u"QPSK_1RB_0", None))
        self.qpsk_prb0_lte_sig.setText(QCoreApplication.translate("MainWindow", u"QPSK_PRB_0", None))
        self.qpsk_frb_lte_sig.setText(QCoreApplication.translate("MainWindow", u"QPSK_FRB", None))
        self.q16_prb0_lte_sig.setText(QCoreApplication.translate("MainWindow", u"Q16_PRB_0", None))
        self.q16_frb_lte_sig.setText(QCoreApplication.translate("MainWindow", u"Q16_FRB", None))
        self.q64_prb0_lte_sig.setText(QCoreApplication.translate("MainWindow", u"Q64_PRB_0", None))
        self.q64_frb_lte_sig.setText(QCoreApplication.translate("MainWindow", u"Q64_FRB", None))
        self.q256_frb_lte_sig.setText(QCoreApplication.translate("MainWindow", u"Q256_FRB", None))
        ...
        self.init_rx_sync_level_label_2.setText(QCoreApplication.translate("MainWindow", u"Outer_Loop", None))
        self.init_rx_sync_level_label.setText(QCoreApplication.translate("MainWindow", u"Rx_Sync_level", None))
        self.et_tracker_label.setText(QCoreApplication.translate("MainWindow", u"ET_Tracker", None))
        self.et_tracker_comboBox.setItemText(0, QCoreApplication.translate("MainWindow", u"sky51001", None))
        self.et_tracker_comboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"qm81052", None))

        self.tabWidget.setTabText(self.tabWidget.indexOf(self.nonsig_extra_setting), QCoreApplication.translate("MainWindow", u"NonSig", None))
        ...
        self.baseRegyFileUpdateButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Changed Regy", None))
        self.changedRegyFileUpdateButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.mergeButton.setText(QCoreApplication.translate("MainWindow", u"Merge", None))
        self.groupBox_7.setTitle(QCoreApplication.translate("MainWindow", u"Separate NV", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Base Regy", None))
        self.baseRegyFileSeparateButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Separate txt", None))
        self.txtFileSeparateButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.seperateButton.setText(QCoreApplication.translate("MainWindow", u"Separate", None))
        self.groupBox_8.setTitle(QCoreApplication.translate("MainWindow", u"Parse cfg", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Base Regy", None))
        self.baseRegyFileParseButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Parse cfg", None))
        self.cfgFileParseButton.setText(QCoreApplication.translate("MainWindow", u"...", None))
        self.parseButton.setText(QCoreApplication.translate("MainWindow", u"Parse", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.regy_oper), QCoreApplication.translate("MainWindow", u"Regy", None))
...
"Disable", None))
        ...
        self.rx_level_sweep_ns.setText(QCoreApplication.translate("MainWindow", u"Rx_level_sweep", None))
