...
class CMW:
    ...
    def set_rf_tx_port_nr(self, port_tx=1):
        """
        Activates the standalone scenario and selects the RF input path for the measured RF
        signal.
    ...
    def set_repetition_nr(self, rep='SING'):
        """
        Specifies the repetition mode of the measurement. The repetition mode specifies
        whether the measurement is stopped after a single shot or repeated continuously. Use
        CONFigure:..:MEAS<i>:...:SCOunt to determine the number of measurement
    ...
    def set_trigger_source_nr(self, source='Free Run'):
        """
        Selects the source of the trigger events. Some values are always available. They are
        listed below. Depending on the installed options, additional values are available. You
        can query a list of all supported values via TRIGger:...:CATalog:SOURce?.
    ...
    def set_expect_power_nr(self, exp_nom_pwr=0.00):
        """
        Sets the expected nominal power of the measured RF signal.
        Parameters:
        <ExpNomPow> numeric
    ...
    def set_rf_setting_user_margin_nr(self, margin=10.00):
        """
        Sets the margin that the measurement adds to the expected nominal power to deter-
        mine the reference power. The reference power minus the external input attenuation
        must be within the power range of the selected input connector. Refer to the data
    ...
    def set_rf_setting_external_tx_port_attenuation_nr(self, attenuation):
        """
        Defines an external attenuation (or gain, if the value is negative), to be applied to the
        input connector.
        Parameters:
    ...
    def set_measure_start_on_nr(self):
        """
        Starts, stops, or aborts the measurement:
        ● INITiate... starts or restarts the measurement. The measurement enters the
        "RUN" state.
    ...
    def get_power_state_query_nr(self):
        """
        Queries the main measurement state. Use FETCh:...:STATe:ALL? to query the
        measurement state including the substates. Use INITiate..., STOP...,
        ABORt... to change the measurement state.
    ...
    def set_uldl_periodicity_nr(self, periodicity='MS10'):
        """
    ...
    def set_duplexer_mode_nr(self, mode='FDD'):
        """
    ...
    def set_modulation_count_nr(self, count=5):
        """
        Specifies the statistic count of the measurement. The statistic count is equal to the
        number of measurement intervals per single shot.
        Parameters:
    ...
    def set_tx_freq_nr(self, tx_freq):  # this is KHz
        """
    ...
    def set_meas_on_exception_nr(self, meas_on_exception='ON'):
        """
    ...
    def set_spectrum_limit_nr(self, area, bw10, start_freq, stop_freq, level, rbw):
        """
    ...
    def set_pusch_nr(self, mcs, rb_size, rb_start):
        """
    ...
    def set_precoding_nr(self, _type_fr1):
        """
    ...
    def set_phase_compensation_nr(self, phase_comp='OFF', user_freq=6000000000):
        """
    ...
    def set_channel_type_nr(self, ctype='PUSC'):
        """
    ...
    def set_uldl_pattern_nr(self, scs):
        """
    ...
    def set_aclr_count_nr(self, count=5):
        """
        Specifies the statistic count of the measurement. The statistic count is equal to the
        number of measurement intervals per single shot.
    ...
    def set_sem_count_nr(self, count=5):
        """
        Specifies the statistic count of the measurement. The statistic count is equal to the
        number of measurement intervals per single shot.
        Separate statistic counts for ACLR and spectrum emission mask measurements are
    ...
    def set_trigger_threshold_nr(self, threshold=-20.0):
        """
    ...
    def set_measurements_enable_all_nr(self):
        """
    ...
    def set_measured_subframe_nr(self, subframe=10):
        """
    ...
    def set_measured_slot_nr(self, measured_slot='ALL'):
        """
    ...
    def set_scenario_activate_nr(self, scenario='SAL'):
        """
    ...
    def get_modulation_average_query_nr(self):
        """
    ...
    def get_aclr_average_query_nr(self):
        """
    ...
    def get_in_band_emission_query_nr(self):
        """
    ...
    def get_flatness_extreme_query_nr(self):
        """
    ...
    def get_sem_average_query_nr(self):
        """
    ...
    def get_sem_margin_all_query_nr(self):
        """
