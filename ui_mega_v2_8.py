...
################################################################################
## Form generated from reading UI file 'mega_v2_8.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget1 = QWidget(self.rb_lte_group)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(10, 20, 361, 311))
        ...
        self.widget2.setGeometry(QRect(10, 200, 91, 48))
        self.verticalLayout_criteria_ulca_lte = QVBoxLayout(self.widget2)
        ...
        self.criteria_ulca_lte_3gpp_radioButton = QRadioButton(self.widget2)
        ...
        self.criteria_ulca_lte_fcc_radioButton = QRadioButton(self.widget2)
